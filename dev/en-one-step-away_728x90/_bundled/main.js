...
function tween(heroFunk) {
	...
	_commonJs.tl.from('.bg', .5, { y: _commonJs.size.h, ease: Power2.easeOut }, .2);
...
function hero_mask() {
	...
	_commonJs.tl.fromTo('.hero', .6, mask_from, mask_to, 't1+=.5');
}
...
(0, _commonJsTween_lbJs2['default'])('hero_mask');
